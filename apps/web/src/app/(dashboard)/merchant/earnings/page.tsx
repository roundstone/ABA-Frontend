...
export default function MerchantEarningPage() {
      ...
      <div className="dashboard-right">
        <div className="dashboard">
          ...
          <div className="box-account">
            ...
            {/* Show Recipient info for merchants/admins to help with transparency */}
            <CommissionLedgerTable entries={earnings} showRecipient={true} isAdmin={true} />
          </div>
        </div>
      </div>
    </div>
